...
export enum PeripheralDataKey {
  ...
  MagY = "MagY",
  MagZ = "MagZ",
  ElectricQuantityPercentage = "ElectricQuantityPercentage",
...
export enum WitBleEventType {
   ...
   * [Android only]
   */
  WitBleManagerPeripheralDidBond = "WitBleManagerPeripheralDidBond",
  /**
   * [iOS only]
   */
  WitBleManagerCentralManagerWillRestoreState = "WitBleManagerCentralManagerWillRestoreState",
  /**
   * [iOS only]
   */
...
export interface WitBleManagerDidUpdateValueForCharacteristicEvent {
  /**
   * characteristic UUID
   */
 ...
 * [iOS only]
 */
export interface WitBleManagerDidUpdateNotificationStateForEvent {
  /**
   * peripheral id
   */
  readonly peripheral: string;
 ...
 */
export type WitBleManagerCompanionFailure = { error: string };
 ...
 */
export type WitBleManagerCompanionPeripheral = Peripheral | null;
