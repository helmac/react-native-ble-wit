...
class WitBleManager: RCTEventEmitter, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func getDeviceData(_ peripheralUUID: String) -> [String:String?] {
        if let peripheral = peripherals[peripheralUUID], peripheral.instance.state == .connected {
            ...
            s["Q0"] = peripheral.bwt901ble?.getDeviceData(WitSensorKey.Q0)
            s["Q1"] = peripheral.bwt901ble?.getDeviceData(WitSensorKey.Q1)
            s["Q2"] = peripheral.bwt901ble?.getDeviceData(WitSensorKey.Q2)
            s["Q3"] = peripheral.bwt901ble?.getDeviceData(WitSensorKey.Q3)
